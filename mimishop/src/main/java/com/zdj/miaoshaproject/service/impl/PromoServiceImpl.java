...
import com.zdj.miaoshaproject.dao.PromoDOMapper;
...
public class PromoServiceImpl implements PromoService {
    ...
    public void deletePromo(Integer promoId) {
        promoDOMapper.deleteByPrimaryKey(promoId);


    }

    @Override
    public void createPromo(PromoDO promoDO) {
        promoDOMapper.insert(promoDO);
    }

    @Override
    public List<PromoModel> listPromo() {
        List<PromoDO> promoDOS = promoDOMapper.selectPromos();
